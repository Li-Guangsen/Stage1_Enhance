...
- 输出目录：`docs/fa01_high_risk_sample_index_20260527/`
...
- 样本摘要：`docs/fa01_high_risk_sample_index_20260527/fa01_high_risk_sample_summary.csv`
- Stage1/raw/GT 路径：`docs/fa01_high_risk_sample_index_20260527/fa01_high_risk_stage1_paths.csv`
- MyEdge detector 输出路径：`docs/fa01_high_risk_sample_index_20260527/fa01_high_risk_detector_paths.csv`
- JSON index：`docs/fa01_high_risk_sample_index_20260527/fa01_high_risk_index.json`
