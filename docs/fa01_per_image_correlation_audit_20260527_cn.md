...
- 输入：`docs/fa01_stage1_full_flow_family_audit_tables_20260527/fa01_enhancement_proxy_168_per_image.csv` 与 MyEdge structure-proxy per-image CSV。
- 边界：本审计只计算 per-image proxy 相关；不重算 ODS/OIS/AP/AC，不运行 sampling/eval/show，不训练，不生成新候选。

## 2. 产物

- 合并明细：`docs/fa01_per_image_correlation_audit_20260527/fa01_per_image_enhancement_structure_merged.csv`
- 全量相关：`docs/fa01_per_image_correlation_audit_20260527/fa01_per_image_correlations.csv`
- Top correlations：`docs/fa01_per_image_correlation_audit_20260527/fa01_top_correlations.csv`
- Top adverse cases：`docs/fa01_per_image_correlation_audit_20260527/fa01_top_adverse_per_image_cases.csv`
- Variant summary：`docs/fa01_per_image_correlation_audit_20260527/fa01_per_image_correlation_variant_summary.csv`
- JSON index：`docs/fa01_per_image_correlation_audit_20260527/fa01_per_image_correlation_index.json`
