...
- `docs/fa01_stage1_sidecar_map_smoke_20260527/` 与 `docs/fa01_visual_error_map_review_20260527/` 是小型证据包，可作为 FA01 可见证据纳入版本化记忆。
...
- `docs/stage1_myedge168_gt_edge_proxy_prescreen_topology_locked_visual_chroma_v1_myedgeinput_grayplane090_anchorfix_20260527_cn.md`
