...
4. `docs/stage1_full_enhancement_mainline_recovery_plan_cn.md`
5. `docs/stage1_full_flow_failure_audit_and_next_goal_20260527_cn.md`
6. `docs/stage1_full_flow_family_failure_audit_fa01_20260527_cn.md`
7. `docs/stage1_detector_sensitivity_hypotheses_fa01_20260527_cn.md`
8. `docs/fa01_high_risk_sample_evidence_index_20260527_cn.md`
9. `docs/fa01_per_image_correlation_audit_20260527_cn.md`
10. `docs/fa01_visual_error_map_review_20260527_cn.md`
11. `docs/myedge_msfi_stage1_sidecar_adaptation_protocol_fa01_20260527_cn.md`
12. `docs/stage1_sidecar_map_definition_fa01_20260527_cn.md`
13. `docs/stage1_long_horizon_goal_after_tlvc01_20260527_cn.md`
14. `docs/evidence_asset_inventory_cn.md`
15. `metrics/registry_schema_cn.md`
16. `metrics/experiment_registry.csv`
17. `metrics/candidate_registry.csv`
18. `docs/project_status_overview_cn.md`
19. `docs/project_handoff_guide_cn.md`
20. `research-state.yaml`
...
- D01 没有达成原始“完整创新增强流程 + 明显视觉增强 + 增强指标竞争力 + 下游正收益”目标；后续纠偏入口是 `docs/stage1_full_enhancement_mainline_recovery_plan_cn.md`。
...
- FA01 已完成 failure audit、high-risk index、per-image correlation 和 visual/error-map review：`docs/stage1_full_flow_family_failure_audit_fa01_20260527_cn.md`、`docs/fa01_high_risk_sample_evidence_index_20260527_cn.md`、`docs/fa01_per_image_correlation_audit_20260527_cn.md`、`docs/fa01_visual_error_map_review_20260527_cn.md` 和 `docs/stage1_detector_sensitivity_hypotheses_fa01_20260527_cn.md` 是下一阶段入口；不得新增 FF03/P29/D02 作为同族小修。
- TLVC01 后的长期目标入口是 `docs/stage1_long_horizon_goal_after_tlvc01_20260527_cn.md`：保留完整 Stage1 增强流程，但从 direct replacement 转为 raw 主输入旁路的 sidecar evidence / auxiliary maps，再由 MyEdge/MSFI adaptation 验证正收益。
- 当前推荐路线是 MyEdge/MSFI sidecar adaptation protocol 草案与 no-training map export smoke：`docs/myedge_msfi_stage1_sidecar_adaptation_protocol_fa01_20260527_cn.md`、`docs/stage1_sidecar_map_definition_fa01_20260527_cn.md`。它们不是 fixed-detector 结果，也不授权训练。
