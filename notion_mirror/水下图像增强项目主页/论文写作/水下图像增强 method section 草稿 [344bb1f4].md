...
- **Notion URL**: https://www.notion.so/344bb1f4e23e81d7952afa49b59827c1
- **Ancestor Path**: 水下图像增强项目主页 / 论文写作
- **Exported On**: 2026-04-17

## Properties
- **内容摘要**: 基于当前仓库真实实现整理一版 method section 草稿，覆盖灰像素引导白平衡、IMF1Ray 细节分支、白平衡安全对比分支、CLAHE 引导局部可见性分支、特征门控融合与最终收口；对应本地主文件为仓库根目录下的 method-underwater-enhancement.md。
- **条目**: 水下图像增强 method section 草稿
- **状态**: 草稿中
- **类型**: method
